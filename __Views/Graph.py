...
from __Controllers import MplController
...
class Graph(tk.Tk):
    ...
    def create_view(self, controller:MplController, model:Stocks):
        print('55555')
        # self.state('zoomed')
        ...
        selected_period = tk.StringVar(None,'1y')
        period = (('1 Day', '1d'),
                ('5 Days', '5d'),
                ('1 Month', '1mo'),
                ('3 Months', '3mo'),
        ...
        def create_candle(self, df:pd.DataFrame):
